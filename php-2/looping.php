...
*/ 
$items = [ 
['001', 'Keyboard Logitek', 60000, 'Keyboard yang mantap untuk kantoran', 'buga.webp'],  
...
// Looping untuk mengubah setiap item ke dalam bentuk array asosiatif
...
// Looping untuk membuat pola asteriks
for ($i = 1; $i <= 5; $i++) {
    for ($j = 1; $j <= $i; $j++) {
        echo "* ";
    }
